...
| **Stripe** | Payment tokens, transaction history | Process credit purchases |
...
- **Process Payments** - Manage credits and transactions via Stripe
...
|---------|---------|---------------------|
| **Auth0** | User authentication | [auth0.com/privacy](https://auth0.com/privacy) |
| **Stripe** | Payment processing | [stripe.com/privacy](https://stripe.com/privacy) |
| **PostGrid** | Letter printing and mailing | [postgrid.com/privacy](https://www.postgrid.com/privacy-policy) |
| **Neon** | Database hosting | [neon.tech/privacy](https://neon.tech/privacy-policy) |
| **Railway** | Application hosting | [railway.app/legal/privacy](https://railway.app/legal/privacy) |
| **OpenAI** | AI interface (ChatGPT) | [openai.com/privacy](https://openai.com/policies/privacy-policy) |
...
| **Support and Audit Records** | Records of actions our team takes on your account are kept for up to 2 years after the action, including after your account is deleted. |
