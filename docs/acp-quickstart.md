...
An 8-week plan for adding Agentic Commerce Protocol (ACP) purchasing once the platform allows it.
The checkmarks below record the planning work done in late 2025, not implementation.
