...
> = {
  ...
  description:
    "Preview a physical letter draft with a header image at the top. This does not send mail. Requires a real U.S. recipient mailing address; prefer a direct file attachment for the image and use upload_image if attachment handoff fails. Send later with send_letter.",
