export const LETTER_IRL_SERVER_INSTRUCTIONS = [
  ...
  "For new images, use ChatGPT's built-in image generation (image_gen); its images can be attached to Letter IRL previews directly. Selecting or @-mentioning the Letter IRL app while asking for an image is not, by itself, a request for Letter IRL to generate it.",
